...
!function(t, n) {
    ...
    return function(e) {
        ...
        var r = function(e, t) {
            ...
            return m[e.toLowerCase()] || !1;
        }, g = function() {
            function e(t) {
                !function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                }(this, e);
                var n = Array.isArray(t) ? h(t) : i(t) || c(t) || f(t) || p(t) || l(t) || [ 0, 0, 0, null ], o = r(n, 4), a = o[0], u = o[1], s = o[2], d = o[3];
                this.r = a, this.g = u, this.b = s, this.a = d;
            }
            return o(e, [ {
                key: "isTransparent",
                value: function() {
        ...
        var o = function() {
        ...
        }(), a = r(n(7)), i = r(n(27)), u = t.Bounds = function() {
            function e(t, n, r, o) {
                !function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            ...
            return new u(e.left + i + n[3].borderWidth, e.top + r + n[0].borderWidth, e.width - (n[1].borderWidth + n[3].borderWidth + i + o), e.height - (n[0].borderWidth + n[2].borderWidth + r + a));
            ...
            var o = [];
            return e instanceof i.default ? o.push(e.subdivide(.5, !1)) : o.push(e), n instanceof i.default ? o.push(n.subdivide(.5, !0)) : o.push(n), 
            r instanceof i.default ? o.push(r.subdivide(.5, !0).reverse()) : o.push(r), t instanceof i.default ? o.push(t.subdivide(.5, !1).reverse()) : o.push(t), 
            o;
            ...
            var r = e.width / 2, o = e.height / 2, i = n[s.TOP_LEFT][0].getAbsoluteValue(e.width) < r ? n[s.TOP_LEFT][0].getAbsoluteValue(e.width) : r, u = n[s.TOP_LEFT][1].getAbsoluteValue(e.height) < o ? n[s.TOP_LEFT][1].getAbsoluteValue(e.height) : o, l = n[s.TOP_RIGHT][0].getAbsoluteValue(e.width) < r ? n[s.TOP_RIGHT][0].getAbsoluteValue(e.width) : r, d = n[s.TOP_RIGHT][1].getAbsoluteValue(e.height) < o ? n[s.TOP_RIGHT][1].getAbsoluteValue(e.height) : o, f = n[s.BOTTOM_RIGHT][0].getAbsoluteValue(e.width) < r ? n[s.BOTTOM_RIGHT][0].getAbsoluteValue(e.width) : r, h = n[s.BOTTOM_RIGHT][1].getAbsoluteValue(e.height) < o ? n[s.BOTTOM_RIGHT][1].getAbsoluteValue(e.height) : o, p = n[s.BOTTOM_LEFT][0].getAbsoluteValue(e.width) < r ? n[s.BOTTOM_LEFT][0].getAbsoluteValue(e.width) : r, g = n[s.BOTTOM_LEFT][1].getAbsoluteValue(e.height) < o ? n[s.BOTTOM_LEFT][1].getAbsoluteValue(e.height) : o, m = e.width - l, y = e.height - h, v = e.width - f, b = e.height - g;
            return {
                topLeftOuter: i > 0 || u > 0 ? c(e.left, e.top, i, u, s.TOP_LEFT) : new a.default(e.left, e.top),
                topLeftInner: i > 0 || u > 0 ? c(e.left + t[3].borderWidth, e.top + t[0].borderWidth, Math.max(0, i - t[3].borderWidth), Math.max(0, u - t[0].borderWidth), s.TOP_LEFT) : new a.default(e.left + t[3].borderWidth, e.top + t[0].borderWidth),
                topRightOuter: l > 0 || d > 0 ? c(e.left + m, e.top, l, d, s.TOP_RIGHT) : new a.default(e.left + e.width, e.top),
                topRightInner: l > 0 || d > 0 ? c(e.left + Math.min(m, e.width + t[3].borderWidth), e.top + t[0].borderWidth, m > e.width + t[3].borderWidth ? 0 : l - t[3].borderWidth, d - t[0].borderWidth, s.TOP_RIGHT) : new a.default(e.left + e.width - t[1].borderWidth, e.top + t[0].borderWidth),
                bottomRightOuter: f > 0 || h > 0 ? c(e.left + v, e.top + y, f, h, s.BOTTOM_RIGHT) : new a.default(e.left + e.width, e.top + e.height),
                bottomRightInner: f > 0 || h > 0 ? c(e.left + Math.min(v, e.width - t[3].borderWidth), e.top + Math.min(y, e.height + t[0].borderWidth), Math.max(0, f - t[1].borderWidth), h - t[2].borderWidth, s.BOTTOM_RIGHT) : new a.default(e.left + e.width - t[1].borderWidth, e.top + e.height - t[2].borderWidth),
                bottomLeftOuter: p > 0 || g > 0 ? c(e.left, e.top + b, p, g, s.BOTTOM_LEFT) : new a.default(e.left, e.top + e.height),
                bottomLeftInner: p > 0 || g > 0 ? c(e.left + t[3].borderWidth, e.top + b, Math.max(0, p - t[3].borderWidth), g - t[2].borderWidth, s.BOTTOM_LEFT) : new a.default(e.left + t[3].borderWidth, e.top + e.height - t[2].borderWidth)
            };
        }, {
            TOP_LEFT: 0,
            TOP_RIGHT: 1,
            ...
            switch (o) {
              case s.TOP_LEFT:
                return new i.default(new a.default(e, f), new a.default(e, f - c), new a.default(d - l, t), new a.default(d, t));

              case s.TOP_RIGHT:
                return new i.default(new a.default(e, t), new a.default(e + l, t), new a.default(d, f - c), new a.default(d, f));

              case s.BOTTOM_RIGHT:
                return new i.default(new a.default(d, t), new a.default(d, t + c), new a.default(e + l, f), new a.default(e, f));

              case s.BOTTOM_LEFT:
              default:
                return new i.default(new a.default(d, f), new a.default(d - l, f), new a.default(e, t + c), new a.default(e, t));
            }
        };
    }, function(e, t, n) {
        Object.defineProperty(t, "__esModule", {
        ...
        t.default = a, t.calculateLengthFromValueWithUnit = function(e, t, n) {
            switch (n) {
              case "px":
              case "%":
                return new a(t + n);
              ...
              case "rem":
                var r = new a(t);
                return r.value *= "em" === n ? parseFloat(e.style.font.fontSize) : function e(t) {
                    var n = t.parent;
        ...
        }(n(0)), a = n(3), i = n(6), u = n(10), l = n(28), s = n(29), c = n(30), d = n(31), f = n(32), h = n(33), p = n(14), g = n(15), m = n(9), y = n(34), v = n(16), b = n(35), w = n(36), E = n(37), T = n(1), O = n(17), I = [ "INPUT", "TEXTAREA", "SELECT" ], _ = function() {
            function e(t, n, r, a) {
                var _ = this;
                !function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                }(this, e), this.parent = n, this.index = a, this.childNodes = [];
                var P = t.ownerDocument.defaultView, S = P.pageXOffset, x = P.pageYOffset, A = P.getComputedStyle(t, null), N = (0, 
                s.parseDisplay)(A.display), C = "radio" === t.type || "checkbox" === t.type, L = (0, 
                g.parsePosition)(A.position);
                this.style = {
                    background: C ? O.INPUT_BACKGROUND : (0, i.parseBackground)(A, r),
                    border: C ? O.INPUT_BORDERS : (0, u.parseBorder)(A),
                    borderRadius: (t instanceof P.HTMLInputElement || t instanceof HTMLInputElement) && C ? (0, 
                    O.getInputBorderRadius)(t) : (0, l.parseBorderRadius)(A),
                    color: C ? O.INPUT_COLOR : new o.default(A.color),
                    display: N,
                    float: (0, c.parseCSSFloat)(A.float),
                    font: (0, d.parseFont)(A),
                    letterSpacing: (0, f.parseLetterSpacing)(A.letterSpacing),
                    opacity: parseFloat(A.opacity),
                    overflow: -1 === I.indexOf(t.tagName) ? (0, h.parseOverflow)(A.overflow) : h.OVERFLOW.HIDDEN,
                    padding: (0, p.parsePadding)(A),
                    position: L,
                    textDecoration: (0, m.parseTextDecoration)(A),
                    textShadow: (0, y.parseTextShadow)(A.textShadow),
                    textTransform: (0, v.parseTextTransform)(A.textTransform),
                    transform: (0, b.parseTransform)(A),
                    visibility: (0, w.parseVisibility)(A.visibility),
                    zIndex: (0, E.parseZIndex)(L !== g.POSITION.STATIC ? A.zIndex : "auto")
                }, this.isTransformed() && (t.style.transform = "matrix(1,0,0,1,0,0)"), "IMG" === t.tagName && t.addEventListener("load", function() {
                    _.bounds = (0, T.parseBounds)(t, S, x), _.curvedBounds = (0, T.parseBoundCurves)(_.bounds, _.style.border, _.style.borderRadius);
                }), this.image = R(t, r), this.bounds = C ? (0, O.reformatInputBounds)((0, T.parseBounds)(t, S, x)) : (0, 
                T.parseBounds)(t, S, x), this.curvedBounds = (0, T.parseBoundCurves)(this.bounds, this.style.border, this.style.borderRadius);
            }
            return r(e, [ {
                key: "getClipPaths",
                value: function() {
                    var e = this.parent ? this.parent.getClipPaths() : [];
                    return this.style.overflow === h.OVERFLOW.HIDDEN || this.style.overflow === h.OVERFLOW.SCROLL ? e.concat([ (0, 
                    T.calculatePaddingBoxPath)(this.curvedBounds) ]) : e;
                }
            }, {
                key: "isInFlow",
                value: function() {
                ...
                key: "isVisible",
                value: function() {
                    return !(0, a.contains)(this.style.display, s.DISPLAY.NONE) && this.style.opacity > 0 && this.style.visibility === w.VISIBILITY.VISIBLE;
                }
            }, {
                ...
                key: "isInlineLevel",
                value: function() {
                    return (0, a.contains)(this.style.display, s.DISPLAY.INLINE) || (0, a.contains)(this.style.display, s.DISPLAY.INLINE_BLOCK) || (0, 
                    a.contains)(this.style.display, s.DISPLAY.INLINE_FLEX) || (0, a.contains)(this.style.display, s.DISPLAY.INLINE_GRID) || (0, 
                    a.contains)(this.style.display, s.DISPLAY.INLINE_LIST_ITEM) || (0, a.contains)(this.style.display, s.DISPLAY.INLINE_TABLE);
                }
            }, {
                key: "isInlineBlockOrInlineTable",
                value: function() {
                    return (0, a.contains)(this.style.display, s.DISPLAY.INLINE_BLOCK) || (0, a.contains)(this.style.display, s.DISPLAY.INLINE_TABLE);
                }
            } ]), e;
        }();
        t.default = _;
        ...
        var o = r(n(0)), a = r(n(2)), i = r(n(26)), u = r(n(7)), l = n(1), s = n(14), c = t.BACKGROUND_REPEAT = {
            REPEAT: 0,
            NO_REPEAT: 1,
            REPEAT_X: 2,
            REPEAT_Y: 3
            ...
            PADDING_BOX: 1,
            CONTENT_BOX: 2
        }, h = t.BACKGROUND_ORIGIN = f, p = function e(t) {
            switch (function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            }(this, e), t) {
              case "contain":
              ...
              default:
                this.value = new a.default(t);
            }
        }, g = (t.calculateBackgroundSize = function(e, t, n) {
            var r = 0, o = 0, a = e.size;
            if (a[0].size === d.CONTAIN || a[0].size === d.COVER) {
                var u = n.width / n.height, l = t.width / t.height;
                return u < l != (a[0].size === d.COVER) ? new i.default(n.width, n.width / l) : new i.default(n.height * l, n.height);
            }
            return a[0].value && (r = a[0].value.getAbsoluteValue(n.width)), a[0].size === d.AUTO && a[1].size === d.AUTO ? o = t.height : a[1].size === d.AUTO ? o = r / t.width * t.height : a[1].value && (o = a[1].value.getAbsoluteValue(n.height)), 
            a[0].size === d.AUTO && (r = o / t.height * t.width), new i.default(r, o);
            ...
            return new i.default(r, o);
        }, new p("auto")), m = (t.calculateBackgroungPaintingArea = function(e, t) {
            switch (t) {
              case f.BORDER_BOX:
            ...
            var o = (0, l.calculatePaddingBox)(t, r);
            switch (e) {
              case h.BORDER_BOX:
                return t;

              case h.CONTENT_BOX:
                var a = n[s.PADDING_SIDES.LEFT].getAbsoluteValue(t.width), i = n[s.PADDING_SIDES.RIGHT].getAbsoluteValue(t.width), u = n[s.PADDING_SIDES.TOP].getAbsoluteValue(t.width), c = n[s.PADDING_SIDES.BOTTOM].getAbsoluteValue(t.width);
                return new l.Bounds(o.left + a, o.top + u, o.width - a - i, o.height - u - c);
            ...
            var n = E(e.backgroundImage).map(function(e) {
                if ("url" === e.method) {
            ...
            return n.map(function(e, t) {
                var n = (a[t] || "auto").trim().split(" ").map(b), i = (r[t] || "auto").trim().split(" ").map(w);
                return {
                    source: e,
                    repeat: function(e) {
                        switch (("string" == typeof o[t] ? o[t] : o[0]).trim()) {
                          case "no-repeat":
                            return c.NO_REPEAT;
        ...
        }, E = t.parseBackgroundImage = function(e) {
        ...
        var r = n(19), o = function(e) {
            ...
            get SUPPORT_BASE64_DRAWING() {
                return function(e) {
                    ...
                    return Object.defineProperty(a, "SUPPORT_BASE64_DRAWING", {
                        value: function() {
                            return t;
                        }
                    }), t;
            ...
            get SUPPORT_FOREIGNOBJECT_DRAWING() {
                var e = "function" == typeof Array.from && "function" == typeof window.fetch ? function(e) {
                    ...
                    var a = new Image(), i = t.toDataURL();
                    a.src = i;
                    var u = (0, r.createForeignObjectSVG)(100, 100, 0, 0, a);
                    return n.fillStyle = "red", n.fillRect(0, 0, 100, 100), (0, r.loadSerializedSVG)(u).then(function(t) {
                        n.drawImage(t, 0, 0);
                        var a = n.getImageData(0, 0, 100, 100).data;
                        n.fillStyle = "red", n.fillRect(0, 0, 100, 100);
                        var u = e.createElement("div");
                        return u.style.backgroundImage = "url(" + i + ")", u.style.height = "100px", o(a) ? (0, 
                        r.loadSerializedSVG)((0, r.createForeignObjectSVG)(100, 100, 0, 0, u)) : Promise.reject(!1);
                    }).then(function(e) {
        ...
        t.parseBorder = function(e) {
            return i.map(function(t) {
                var n = new r.default(e.getPropertyValue("border-" + t + "-color")), a = function(e) {
                    switch (e) {
                      case "none":
                        return o.NONE;
                    }
                    return o.SOLID;
                }(e.getPropertyValue("border-" + t + "-style")), i = parseFloat(e.getPropertyValue("border-" + t + "-width"));
                return {
                    borderColor: n,
                    borderStyle: a,
        ...
        var o = function() {
            ...
            return o(e, null, [ {
                ...
                value: function(t, n) {
                    ...
                    return new e(r, n, (0, i.parseTextBounds)(r, n, t));
                }
            } ]), e;
        }();
        t.default = u;
        ...
        var r = function() {
            ...
            return r(e, [ {
                ...
                value: function(e, t) {
                    ...
                    i(t, n), this.ctx.fillStyle = n, this.ctx.fillRect(e.left, e.top, e.width, e.height);
                }
            }, {
                key: "renderRadialGradient",
                value: function(e, t) {
                    var n = this, r = e.left + t.center.x, o = e.top + t.center.y, a = this.ctx.createRadialGradient(r, o, 0, r, o, t.radius.x);
                    if (a) if (i(t, a), this.ctx.fillStyle = a, t.radius.x !== t.radius.y) {
                        var u = e.left + .5 * e.width, l = e.top + .5 * e.height, s = t.radius.y / t.radius.x, c = 1 / s;
                        this.transform(u, l, [ 1, 0, 0, s, 0, 0 ], function() {
                ...
                value: function(e, t, n, r, o) {
                    ...
                    e.forEach(function(e) {
                        if (i.ctx.fillStyle = t.toString(), o && e.text.trim().length ? o.slice(0).reverse().forEach(function(t) {
                            i.ctx.shadowColor = t.color.toString(), i.ctx.shadowOffsetX = t.offsetX * i.options.scale, 
                            i.ctx.shadowOffsetY = t.offsetY * i.options.scale, i.ctx.shadowBlur = t.blur, i.ctx.fillText(e.text, e.bounds.left, e.bounds.top + e.bounds.height);
                            ...
                            r.textDecorationLine.forEach(function(t) {
                                switch (t) {
                                  case a.TEXT_DECORATION_LINE.UNDERLINE:
                                    var r = i.options.fontMetrics.getMetrics(n).baseline;
                                    i.rectangle(e.bounds.left, Math.round(e.bounds.top + r), e.bounds.width, 1, u);
                                    break;

                                  case a.TEXT_DECORATION_LINE.OVERLINE:
                                    i.rectangle(e.bounds.left, Math.round(e.bounds.top), e.bounds.width, 1, u);
                                    break;

                                  case a.TEXT_DECORATION_LINE.LINE_THROUGH:
                                    var o = i.options.fontMetrics.getMetrics(n).middle;
                                    i.rectangle(e.bounds.left, Math.ceil(e.bounds.top + o), e.bounds.width, 1, u);
                                }
                            });
                        }
                    });
        ...
        n(18), n(3)), f = (t.INPUT_COLOR = new s.default([ 42, 42, 42 ]), new s.default([ 165, 165, 165 ])), h = new s.default([ 222, 222, 222 ]), p = {
            borderWidth: 1,
            borderColor: f,
        ...
        }, new c.default("50%")), m = [ g, g ], y = [ m, m, m, m ], v = new c.default("3px"), b = [ v, v ], w = [ b, b, b, b ], E = (t.getInputBorderRadius = function(e) {
            return "radio" === e.type ? y : w;
        ...
        var r = n(38), o = n(1), a = n(9), i = function(e) {
            return e && e.__esModule ? e : {
                default: e
            };
        }(n(8)), u = /[^\u0000-\u00ff]/, l = function(e) {
            ...
            for (var o = r.ucs2.decode(e), h = 0 !== t.style.letterSpacing || function(e) {
                return u.test(e);
            }(e) ? o.map(l) : f(o), p = h.length, g = n.parentNode ? n.parentNode.ownerDocument.defaultView : null, m = g ? g.pageXOffset : 0, y = g ? g.pageYOffset : 0, v = [], b = 0, w = 0; w < p; w++) {
                var E = h[w];
                if (t.style.textDecoration !== a.TEXT_DECORATION.NONE || E.trim().length > 0) if (i.default.SUPPORT_RANGE_BOUNDS) v.push(new s(E, d(n, b, E.length, m, y))); else {
                    var T = n.splitText(E.length);
                    v.push(new s(E, c(n, m, y))), n = T;
                } else i.default.SUPPORT_RANGE_BOUNDS || (n = n.splitText(E.length));
                b += E.length;
            }
            return v;
        }, function(e, t, n) {
            ...
            return i.setStart(e, t), i.setEnd(e, t + n), o.Bounds.fromClientRect(i.getBoundingClientRect(), r, a);
        }, f = function(e) {
            for (var t = [], n = 0, o = !1, a = void 0; e.length; ) h(e[n]) === o ? ((a = e.splice(0, n)).length && t.push(r.ucs2.encode(a)), 
            o = !o, n = 0) : n++, n >= e.length && (a = e.splice(0, n)).length && t.push(r.ucs2.encode(a));
            return t;
        }, h = function(e) {
        ...
        var r = function() {
            ...
            return r(e, [ {
                ...
                value: function(e) {
                    ...
                    var n = a(Math.max(e.windowWidth, e.width) * e.scale, Math.max(e.windowHeight, e.height) * e.scale, e.scrollX * e.scale, e.scrollY * e.scale, this.element);
        ...
        t.default = o;
        var a = t.createForeignObjectSVG = function(e, t, n, r, o) {
        ...
        t.FontMetrics = function() {
            ...
            return r(e, [ {
                key: "_parseMetrics",
                value: function(e) {
                    var t = this._document.createElement("div"), n = this._document.createElement("img"), r = this._document.createElement("span"), a = this._document.body;
                    if (!a) throw new Error("");
                    t.style.visibility = "hidden", t.style.fontFamily = e.fontFamily, t.style.fontSize = e.fontSize, 
                    t.style.margin = "0", t.style.padding = "0", a.appendChild(t), n.src = o.SMALL_IMAGE, 
        ...
        var a = Object.assign || function(e) {
            ...
            var n = t || {}, r = new l.default("boolean" != typeof n.logging || n.logging), o = e.ownerDocument;
            if (!o) return Promise.reject("Provided element is not within a Document");
            var d = o.defaultView, f = d.pageXOffset, h = d.pageYOffset, p = "HTML" === e.tagName || "BODY" === e.tagName ? (0, 
            c.parseDocumentSize)(o) : (0, c.parseBounds)(e, f, h), g = p.width, m = p.height, y = p.left, v = p.top, b = {
                async: !0,
                allowTaint: !1,
            ...
            return (0, s.renderElement)(e, a({}, b, n), r);
        };
        ...
        t.renderElement = function e(t, n, r) {
            var p = t.ownerDocument, g = new s.Bounds(n.scrollX, n.scrollY, n.windowWidth, n.windowHeight), m = p.documentElement ? new h.default(getComputedStyle(p.documentElement).backgroundColor) : f.TRANSPARENT, y = p.body ? new h.default(getComputedStyle(p.body).backgroundColor) : f.TRANSPARENT, v = t === p.documentElement ? m.isTransparent() ? y.isTransparent() ? n.backgroundColor ? new h.default(n.backgroundColor) : null : y : m : n.backgroundColor ? new h.default(n.backgroundColor) : null;
            return (n.foreignObjectRendering ? l.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function(l) {
                return l ? function(e) {
                    ...
                    var t = o(e, 3), u = t[0], l = t[1], s = t[2], c = (0, a.NodeParser)(l, s, r), h = l.ownerDocument;
                    return v === c.container.style.background.backgroundColor && (c.container.style.background.backgroundColor = f.TRANSPARENT), 
                    s.ready().then(function(e) {
                        !0 === n.removeContainer && u.parentNode && u.parentNode.removeChild(u);
                        var t = new d.FontMetrics(h), o = {
                            backgroundColor: v,
                            fontMetrics: t,
                            imageStore: e,
                            logger: r,
        ...
        var o = r(n(25)), a = r(n(5)), i = r(n(11)), u = n(17), l = (t.NodeParser = function(e, t, n) {
            ...
            return s(e, i, u, t, r), u;
        }, [ "SCRIPT", "HEAD", "TITLE", "OBJECT", "BR", "OPTION" ]), s = function e(t, n, r, s, f) {
            for (var h, p = t.firstChild; p; p = h) {
                h = p.nextSibling;
                var g = p.ownerDocument.defaultView;
                if (p instanceof g.Text || p instanceof Text || g.parent && p instanceof g.parent.Text) p.data.trim().length > 0 && n.childNodes.push(i.default.fromTextNode(p, n)); else if (p instanceof g.HTMLElement || p instanceof HTMLElement || g.parent && p instanceof g.parent.HTMLElement) {
                    if (-1 === l.indexOf(p.nodeName)) {
                        var m = new a.default(p, n, s, f++);
                        if (m.isVisible()) {
                            "INPUT" === p.tagName ? (0, u.inlineInputElement)(p, m) : "TEXTAREA" === p.tagName ? (0, 
                            u.inlineTextAreaElement)(p, m) : "SELECT" === p.tagName && (0, u.inlineSelectElement)(p, m);
                            var y = "TEXTAREA" !== p.tagName, v = c(m, p);
                            if (v || d(m)) {
                                var b = v || m.isPositioned() ? r.getRealParentStackingContext() : r, w = new o.default(m, b, v);
                                b.contexts.push(w), y && e(p, m, w, s, f);
                            } else r.children.push(m), y && e(p, m, r, s, f);
                        }
                    }
                } else if (p instanceof g.SVGSVGElement || p instanceof SVGSVGElement || g.parent && p instanceof g.parent.SVGSVGElement) {
                    var E = new a.default(p, n, s, f++), T = c(E, p);
                    if (T || d(E)) {
        ...
        var r = function() {
            ...
            function e(t, n, r) {
                !function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                }(this, e), this.container = t, this.parent = n, this.contexts = [], this.children = [], 
        ...
        }(n(7)), i = function(e, t, n) {
            return new a.default(e.x + (t.x - e.x) * n, e.y + (t.y - e.y) * n);
        }, u = function() {
            function e(t, n, r, a) {
                !function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                }(this, e), this.type = o.PATH.BEZIER_CURVE, this.start = t, this.startControl = n, 
                this.endControl = r, this.end = a;
            }
            return r(e, [ {
                key: "subdivide",
                value: function(t, n) {
                    var r = i(this.start, this.startControl, t), o = i(this.startControl, this.endControl, t), a = i(this.endControl, this.end, t), u = i(r, o, t), l = i(o, a, t), s = i(u, l, t);
                    return n ? new e(this.start, r, u, s) : new e(s, l, a, this.end);
                }
            }, {
                key: "reverse",
                value: function() {
        ...
        (function(t, o) {
            ...
            !function(i) {
                ...
                function s(e, t) {
                    var n = e.split("@"), r = "";
                    return n.length > 1 && (r = n[0] + "@", e = n[1]), r + l((e = e.replace(x, ".")).split("."), t).join(".");
                }
                function c(e) {
                ...
                function d(e) {
                    return l(e, function(e) {
                        var t = "";
                        return e > 65535 && (t += L((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), 
                        t += L(e);
                    }).join("");
                }
                function f(e) {
                ...
                function p(e, t, n) {
                    var r = 0;
                    for (e = n ? C(e / O) : e >> 1, e += C(e / t); e > N * E >> 1; r += b) e = C(e / N);
                    return C(r + (N + 1) * e / (e + T));
                }
                function g(e) {
                    var t, n, r, o, a, i, l, s, c, h, g = [], m = e.length, y = 0, T = _, O = I;
                    for ((n = e.lastIndexOf(R)) < 0 && (n = 0), r = 0; r < n; ++r) e.charCodeAt(r) >= 128 && u("not-basic"), 
                    g.push(e.charCodeAt(r));
                    for (o = n > 0 ? n + 1 : 0; o < m; ) {
                        for (a = y, i = 1, l = b; o >= m && u("invalid-input"), ((s = f(e.charCodeAt(o++))) >= b || s > C((v - y) / i)) && u("overflow"), 
                        y += s * i, c = l <= O ? w : l >= O + E ? E : l - O, !(s < c); l += b) i > C(v / (h = b - c)) && u("overflow"), 
                        i *= h;
                        O = p(y - a, t = g.length + 1, 0 == a), C(y / t) > v - T && u("overflow"), T += C(y / t), 
                        y %= t, g.splice(y++, 0, T);
                    }
                    return d(g);
                }
                function m(e) {
                    var t, n, r, o, a, i, l, s, d, f, g, m, y, T, O, P = [];
                    for (m = (e = c(e)).length, t = _, n = 0, a = I, i = 0; i < m; ++i) (g = e[i]) < 128 && P.push(L(g));
                    for (r = o = P.length, o && P.push(R); r < m; ) {
                        for (l = v, i = 0; i < m; ++i) (g = e[i]) >= t && g < l && (l = g);
                        for (l - t > C((v - n) / (y = r + 1)) && u("overflow"), n += (l - t) * y, t = l, 
                        i = 0; i < m; ++i) if ((g = e[i]) < t && ++n > v && u("overflow"), g == t) {
                            for (s = n, d = b; f = d <= a ? w : d >= a + E ? E : d - a, !(s < f); d += b) O = s - f, 
                            T = b - f, P.push(L(h(f + O % T, 0))), s = C(O / T);
                            P.push(L(h(s, 0))), a = p(n, y, r == o), n = 0, ++r;
                        }
                        ++n, ++t;
                    }
                    return P.join("");
                ...
                void 0 === o || e(o);
                var y, v = 2147483647, b = 36, w = 1, E = 26, T = 38, O = 700, I = 72, _ = 128, R = "-", P = /^xn--/, S = /[^\x20-\x7E]/, x = /[\x2E\u3002\uFF0E\uFF61]/g, A = {
                    overflow: "Overflow: input needs wider integers to process",
                    "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                    "invalid-input": "Invalid input"
                }, N = b - w, C = Math.floor, L = String.fromCharCode;
                y = {
                    version: "1.4.1",
                    ucs2: {
                        decode: c,
        ...
        t.default = function e(t, n, o) {
            !function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            }(this, e), this.type = r.PATH.CIRCLE, this.x = t, this.y = n, this.radius = o;
        };
    }, function(e, t, n) {
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var r = function(e, t) {
        ...
        }(), a = n(1), i = (n(20), n(43)), u = function(e) {
            return e && e.__esModule ? e : {
                default: e
            };
        }(n(11)), l = n(6), s = n(10), c = function() {
            function e(t, n) {
                !function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            ...
            return o(e, [ {
                ...
                value: function(e) {
                    var t = this, n = function() {
                        if (e.childNodes.length && e.childNodes.forEach(function(n) {
                            ...
                            if (n) {
                                var r = (0, a.calculateContentBox)(e.bounds, e.style.padding, e.style.border), o = "number" == typeof n.width && n.width > 0 ? n.width : r.width, i = "number" == typeof n.height && n.height > 0 ? n.height : r.height;
                                o > 0 && i > 0 && t.target.clip([ (0, a.calculatePaddingBoxPath)(e.curvedBounds) ], function() {
                                    t.target.drawImage(n, new a.Bounds(0, 0, o, i), r);
                                });
                            }
                        }
                    }, r = e.getClipPaths();
                ...
                value: function(e, t) {
                    ...
                    if (n) {
                        var r = (0, l.calculateBackgroungPositioningArea)(e.style.background.backgroundOrigin, e.bounds, e.style.padding, e.style.border), o = (0, 
                        l.calculateBackgroundSize)(t, n, r), a = (0, l.calculateBackgroundPosition)(t.position, o, r), i = (0, 
                        l.calculateBackgroundRepeatPath)(t, a, o, r, e.bounds), u = Math.round(r.left + a.x), s = Math.round(r.top + a.y);
                        this.target.renderRepeat(i, n, o, u, s);
                    }
                }
            }, {
                key: "renderBackgroundGradient",
                value: function(e, t) {
                    var n = (0, l.calculateBackgroungPositioningArea)(e.style.background.backgroundOrigin, e.bounds, e.style.padding, e.style.border), r = (0, 
                    l.calculateGradientBackgroundSize)(t, n), o = (0, l.calculateBackgroundPosition)(t.position, r, n), u = new a.Bounds(Math.round(n.left + o.x), Math.round(n.top + o.y), r.width, r.height), s = (0, 
                    i.parseGradient)(e, t.source, u);
                    if (s) switch (s.type) {
                      case i.GRADIENT_TYPE.LINEAR_GRADIENT:
                        this.target.renderLinearGradient(u, s);
                        break;
                ...
                key: "renderBorder",
                value: function(e, t, n) {
                    this.target.drawShape((0, a.parsePathForBorder)(n, t), e.borderColor);
                }
            }, {
                key: "renderStack",
                value: function(e) {
                ...
                value: function(e) {
                    var t = f(e), n = r(t, 5), o = n[0], a = n[1], i = n[2], u = n[3], l = n[4], s = d(e), c = r(s, 2), p = c[0], g = c[1];
                    this.renderNodeBackgroundAndBorders(e.container), o.sort(h).forEach(this.renderStack, this), 
                    this.renderNodeContent(e.container), g.forEach(this.renderNode, this), u.forEach(this.renderStack, this), 
                    l.forEach(this.renderStack, this), p.forEach(this.renderNode, this), a.forEach(this.renderStack, this), 
                    i.sort(h).forEach(this.renderStack, this);
                }
            }, {
                key: "render",
                value: function(e) {
                    return this.options.backgroundColor && this.target.rectangle(this.options.x, this.options.y, this.options.width, this.options.height, this.options.backgroundColor), 
                    this.renderStack(e), this.target.getTarget();
                }
            } ]), e;
        }();
        t.default = c;
        ...
        var a = function(e, t) {
            ...
            throw new TypeError("Invalid attempt to destructure non-iterable instance");
        }, i = (r(n(5)), n(44)), u = r(n(0)), l = n(2), s = r(l), c = n(3), d = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i, f = /^([+-]?\d*\.?\d+)% ([+-]?\d*\.?\d+)%$/i, h = /(px)|%|( 0)$/i, p = /^(from|to|color-stop)\((?:([\d.]+)(%)?,\s*)?(.+?)\)$/i, g = /^\s*(circle|ellipse)?\s*((?:([\d.]+)(px|r?em|%)\s*(?:([\d.]+)(px|r?em|%))?)|closest-side|closest-corner|farthest-side|farthest-corner)?\s*(?:at\s*(?:(left|center|right)|([\d.]+)(px|r?em|%))\s+(?:(top|center|bottom)|([\d.]+)(px|r?em|%)))?(?:\s|$)/i, m = t.GRADIENT_TYPE = {
            LINEAR_GRADIENT: 0,
            RADIAL_GRADIENT: 1
        }, y = t.RADIAL_GRADIENT_SHAPE = {
            CIRCLE: 0,
            ELLIPSE: 1
        }, v = {
            ...
            return "linear-gradient" === o ? T(r, n, !!a) : "gradient" === o && "linear" === r[0] ? T([ "to bottom" ].concat(N(r.slice(3))), n, !!a) : "radial-gradient" === o ? O(e, "-webkit-" === a ? A(r) : r, n) : "gradient" === o && "radial" === r[0] ? O(e, N(A(r.slice(1))), n) : void 0;
        }, function(e, t, n) {
            ...
            }), p = f[0].stop, g = 0; g < f.length; g++) if (null !== p) {
                var m = f[g].stop;
                if (null === m) {
                    for (var y = g; null === f[y].stop; ) y++;
                    for (var v = y - g + 1, b = (f[y].stop - p) / v; g < y; g++) p = f[g].stop = p + b;
                } else p = m;
            }
            return f;
        }), T = function(e, t, n) {
            ...
            var r = t[0].match(g), o = r && ("circle" === r[1] || void 0 !== r[3] && void 0 === r[5]) ? y.CIRCLE : y.ELLIPSE, a = {}, i = {};
            ...
            r[7] ? i.x = v[r[7].toLowerCase()] : void 0 !== r[8] && (i.x = (0, l.calculateLengthFromValueWithUnit)(e, r[8], r[9])), 
            r[10] ? i.y = v[r[10].toLowerCase()] : void 0 !== r[11] && (i.y = (0, l.calculateLengthFromValueWithUnit)(e, r[11], r[12])));
            var u = {
                x: void 0 === i.x ? n.width / 2 : i.x.getAbsoluteValue(n.width),
                y: void 0 === i.y ? n.height / 2 : i.y.getAbsoluteValue(n.height)
            }, s = x(r && r[2] || "farthest-corner", o, u, a, n);
            ...
            switch (e) {
              case "closest-side":
                t === y.CIRCLE ? u = l = Math.min(Math.abs(a), Math.abs(a - o.width), Math.abs(i), Math.abs(i - o.height)) : t === y.ELLIPSE && (u = Math.min(Math.abs(a), Math.abs(a - o.width)), 
                l = Math.min(Math.abs(i), Math.abs(i - o.height)));
                break;

              case "closest-corner":
                if (t === y.CIRCLE) u = l = Math.min((0, c.distance)(a, i), (0, c.distance)(a, i - o.height), (0, 
                c.distance)(a - o.width, i), (0, c.distance)(a - o.width, i - o.height)); else if (t === y.ELLIPSE) {
                    var s = Math.min(Math.abs(i), Math.abs(i - o.height)) / Math.min(Math.abs(a), Math.abs(a - o.width)), d = S(o, a, i, !0);
                    l = s * (u = (0, c.distance)(d.x - a, (d.y - i) / s));
                }
                break;

              case "farthest-side":
                t === y.CIRCLE ? u = l = Math.max(Math.abs(a), Math.abs(a - o.width), Math.abs(i), Math.abs(i - o.height)) : t === y.ELLIPSE && (u = Math.max(Math.abs(a), Math.abs(a - o.width)), 
                l = Math.max(Math.abs(i), Math.abs(i - o.height)));
                break;

              case "farthest-corner":
                if (t === y.CIRCLE) u = l = Math.max((0, c.distance)(a, i), (0, c.distance)(a, i - o.height), (0, 
                c.distance)(a - o.width, i), (0, c.distance)(a - o.width, i - o.height)); else if (t === y.ELLIPSE) {
                    var f = Math.max(Math.abs(i), Math.abs(i - o.height)) / Math.max(Math.abs(a), Math.abs(a - o.width)), h = S(o, a, i, !1);
        ...
        }, A = t.transformWebkitRadialGradientArgs = function(e) {
            var t = "", n = "", r = "", o = "", a = 0, i = /^(left|center|right|\d+(?:px|r?em|%)?)(?:\s+(top|center|bottom|\d+(?:px|r?em|%)?))?$/i, u = /^\d+(px|r?em|%)?(?:\s+\d+(px|r?em|%)?)?$/i, l = e[a].match(i);
            l && a++;
            var s = e[a].match(/^(circle|ellipse)?\s*(closest-side|closest-corner|farthest-side|farthest-corner|contain|cover)?$/i);
            s && (t = s[1] || "", "contain" === (r = s[2] || "") ? r = "closest-side" : "cover" === r && (r = "farthest-corner"), 
            a++);
            var c = e[a].match(u);
            c && a++;
            var d = e[a].match(i);
            ...
            f && a++;
            var h = d || l;
            h && h[1] && (o = h[1] + (/^\d+$/.test(h[1]) ? "px" : ""), h[2] && (o += " " + h[2] + (/^\d+$/.test(h[2]) ? "px" : "")));
            var p = f || c;
        ...
        var o = function(e, t) {
        ...
        }(), i = n(1), u = n(21), l = r(n(46)), s = n(3), c = n(6), d = r(n(12)), f = "data-html2canvas-ignore", h = t.DocumentCloner = function() {
            function e(t, n, r, o, a) {
                !function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                }(this, e), this.referenceElement = t, this.scrolledElements = [], this.copyStyles = o, 
                this.inlineImages = o, this.logger = r, this.options = n, this.renderer = a, this.resourceLoader = new l.default(n, r, window), 
            ...
            return a(e, [ {
                ...
                value: function(e) {
                    ...
                    if (e instanceof HTMLIFrameElement) {
                        var r = e.cloneNode(!1), o = S();
                        r.setAttribute("data-html2canvas-internal-iframe-key", o);
                        var a = (0, i.parseBounds)(e, 0, 0), u = a.width, l = a.height;
                        return this.resourceLoader.cache[o] = A(e, this.options).then(function(e) {
                            return t.renderer(e, {
                            ...
                            return new Promise(function(n, o) {
                                ...
                                s.copyCSSStyles)(e.ownerDocument.defaultView.getComputedStyle(e), a), r);
                            });
                        }), r;
                    }
                ...
                value: function(e) {
                    ...
                    for (var r = e.firstChild; r; r = r.nextSibling) (r.nodeType !== Node.ELEMENT_NODE || "SCRIPT" !== r.nodeName && !r.hasAttribute(f)) && (this.copyStyles && "STYLE" === r.nodeName || t.appendChild(this.cloneNode(r)));
                    if (e instanceof n.HTMLElement && t instanceof n.HTMLElement) switch (this.inlineAllImages(y(e, t, w)), 
                    this.inlineAllImages(y(e, t, E)), !this.copyStyles || e instanceof HTMLIFrameElement || (0, 
                    s.copyCSSStyles)(e.ownerDocument.defaultView.getComputedStyle(e), t), this.inlineAllImages(t), 
                    0 === e.scrollTop && 0 === e.scrollLeft || this.scrolledElements.push([ t, e.scrollLeft, e.scrollTop ]), 
                    e.nodeName) {
                      case "CANVAS":
                        this.copyStyles || m(e, t);
                        break;
            ...
            if (r && r.content && "none" !== r.content && "-moz-alt-content" !== r.content && "none" !== r.display) {
                var o = v(r.content), a = o.match(b), i = t.ownerDocument.createElement(a ? "img" : "html2canvaspseudoelement");
                return a ? i.src = v(a[1]) : i.textContent = o, (0, s.copyCSSStyles)(r, i), i.className = T + " " + O, 
                t.className += n === w ? " " + T : " " + O, n === w ? t.insertBefore(i, t.firstChild) : t.appendChild(i), 
                i;
            }
        }, v = function(e) {
            var t = e.substr(0, 1);
            return t === e.substr(e.length - 1) && t.match(/['"]/) ? e.substr(1, e.length - 2) : e;
        }, b = /^url\((.+)\)$/i, w = ":before", E = ":after", T = "___html2canvas___pseudoelement_before", O = "___html2canvas___pseudoelement_after", I = '{\n    content: "" !important;\n    display: none !important;\n}', _ = function(e) {
            R(e, "." + T + w + I + "\n         ." + O + E + I);
        }, R = function(e, t) {
            var n = e.ownerDocument.createElement("style");
            n.innerHTML = t, e.appendChild(n);
        }, P = function(e) {
            var t = o(e, 3), n = t[0], r = t[1], a = t[2];
            n.scrollLeft = r, n.scrollTop = a;
        }, S = function() {
            return Math.ceil(Date.now() + 1e7 * Math.random()).toString(16);
        }, x = /^data:text\/(.+);(base64)?,(.*)$/i, A = function(e, t) {
            try {
            ...
            n.height = t.height.toString(), n.scrolling = "no", n.setAttribute(f, "true"), e.body ? (e.body.appendChild(n), 
        ...
        t.cloneWindow = function(e, t, n, r, o, a) {
            ...
            return N(e, t).then(function(r) {
                var o = r.contentWindow, a = o.document, s = C(r).then(function() {
                    ...
                    i.clonedReferenceElement instanceof o.HTMLElement || i.clonedReferenceElement instanceof e.defaultView.HTMLElement || i.clonedReferenceElement instanceof HTMLElement ? Promise.resolve([ r, i.clonedReferenceElement, i.resourceLoader ]) : Promise.reject("");
                });
                return a.open(), a.write("<!DOCTYPE html><html></html>"), function(e, t, n) {
                    !e.defaultView || t === e.defaultView.pageXOffset && n === e.defaultView.pageYOffset || e.defaultView.scrollTo(t, n);
                }(n.ownerDocument, u, l), a.replaceChild(a.adoptNode(i.documentElement), a.documentElement), 
                a.close(), s;
            });
        };
    }, function(e, t, n) {
        ...
        var o = function() {
            ...
            return o(e, [ {
                ...
                value: function(e) {
                    ...
                    if (!p(e) || a.default.SUPPORT_SVG_DRAWING) {
                ...
                value: function(e) {
                    var t = this;
                    return f(e) ? g(e, this.options.imageTimeout || 0) : this.hasResourceInCache(e) ? this.cache[e] : this.isSameOrigin(e) || "string" != typeof this.options.proxy ? this.xhrImage(e) : this.cache[e] = (0, 
                ...
                value: function(e, t, n) {
                    ...
                    return this.cache[e] = h(t) && !p(t) ? a.default.SUPPORT_BASE64_DRAWING(t).then(o) : o(!0), 
                    e;
                }
            }, {
                key: "isSameOrigin",
