...
Page({
  ...
  getSiteDetail: function (id) {
    var that = this;
    wxRequest.getRequest('v1/common/site/detail', { id: id }, function (res) {
  ...
  collection: function () {
    ...
    if (this.data.isCollection == 2) {
      wxRequest.postRequest('v1/common/site/collection', { site_id: this.data.id }, function (res) {
        that.setData({
          isCollection: 1
        });
      }, 1);
